...
Quintus.SMBScenes = function(Q) {
	...
	Q.scene("level1", function(stage) {
		...
		var goomba = stage.insert(new Q.Goomba({x: 2750, y: 100, limLeft: 2686, limRight: 2924}));
		var goomba2 = stage.insert(new Q.Goomba({x: 2800, y: 100, limLeft: 2686, limRight: 2924}));
		var bloopa3 = stage.insert(new Q.Bloopa({x: 3468, y: 441}));
		var bloopa4 = stage.insert(new Q.Bloopa({x: 3842, y: 441}));
		var bloopa5 = stage.insert(new Q.Bloopa({x: 5355, y: 441}));
		var koopa4 = stage.insert(new Q.Koopa({x: 3200, y: 441,limLeft: 2958, limRight: 3400}));
		var koopa5 = stage.insert(new Q.Koopa({x: 4000, y: 441,sprite: 'KoopaaAnimationRed', limLeft: 3876, limRight: 4454}));
		var goomba3 = stage.insert(new Q.Goomba({x: 1600, y: 441}));
		var goomba4 = stage.insert(new Q.Goomba({x: 1634, y: 441}));
		var goomba5 = stage.insert(new Q.Goomba({x: 4862, y: 441}));
	...
	Q.scene("level2", function(stage) {
		...
		var goomba = stage.insert(new Q.Goomba({x: 510, y: 380, vx: -100, limRight: 544}));
		var bloopa = stage.insert(new Q.Bloopa({x: 680, y: 374}));
		var goomba1 = stage.insert(new Q.Goomba({x: 1500, y: 102, limLeft: 1428, limRight: 1666}));
		var goomba2 = stage.insert(new Q.Goomba({x: 1534, y: 102, limLeft: 1428, limRight: 1666}));
		var goomba2 = stage.insert(new Q.Goomba({x: 1870, y: 374, limLeft: 1802, limRight: 1938}));
